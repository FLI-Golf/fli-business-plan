  ...
  <aside class="bg-muted/40 border-r hidden md:flex flex-col">
    <div class="h-14 border-b px-4 flex items-center lg:px-6">
      <div class="flex items-center gap-2">
        <Shirt class="h-5 w-5" />
        <span class="font-semibold text-xl">Apparel Marketing Plan</span>
      </div>
    </div>
      ...
      <div class="w-full flex-1 flex items-center gap-4">
        <form class="flex-1">
          <div class="relative">
            ...
            <Input
              type="search"
              placeholder="Search apparel plan..."
    ...
    <main class="flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6">
      <Breadcrumb
        items={[
          ...
          { label: 'Apparel Marketing Plan', href: '/apparel' }
        ]}
      />
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-4xl font-bold mb-2">Apparel Marketing Plan</h1>
        <p class="text-xl italic text-muted-foreground mb-4">"FLI Golf isn't just an apparel line — it's the cultural front door to the future of disc golf."</p>
        <div class="max-w-3xl mx-auto text-muted-foreground">
          <p>A strategic marketing plan for the FLI Golf apparel line — covering brand positioning, target audiences, launch phases, budget allocation, and success metrics.</p>
        </div>
      ...
      {:else}
        <div class="text-center py-12">
          ...
          <p class="text-muted-foreground text-lg">No apparel content found</p>
          <p class="text-sm text-muted-foreground mt-2">Add sections via the PocketBase admin panel under the <code>apparel</code> collection.</p>
        </div>
      {/if}
    </main>
  </div>
