<script lang="ts">
    ...
    import { Home, Users, ChevronUp, UserPlus } from "lucide-svelte";
      ...
      <main class="flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6">
        ...
        {#if filteredRecords.length}
          <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-2">
            {#each filteredRecords as record}
              ...
              >
                <div class="bg-gradient-to-r from-emerald-50 to-teal-50 p-6 border-b-2">
                  <div class="flex items-center gap-4">
                    <div class="h-14 w-14 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white flex items-center justify-center shadow-lg">
        ...
        {:else}
          <div class="text-center py-12">
            <p class="text-muted-foreground text-lg">No membership content found</p>
          </div>
        {/if}
      </main>
    </div>
